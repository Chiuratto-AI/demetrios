...
This document tracks current limitations in the Demetrios language implementation. These are planned for future releases.
...
https://github.com/Chiuratto-AI/demetrios/issues
