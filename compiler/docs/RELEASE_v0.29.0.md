# Demetrios v0.29.0 Release Notes

**Release Date:** December 3, 2025

## Overview

This release introduces the **Epistemic Type System** and **4-Layer Ontology Integration**, enabling Demetrios to natively support 15 million ontology terms as first-class types. This is a foundational feature for scientific and biomedical computing.
...
```rust
use demetrios::ontology::{OntologyResolver, ResolvedTerm};
...
*Demetrios: Where ontologies become types.*
