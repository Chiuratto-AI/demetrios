...
mod tests {
    ...
    fn test_build_graph_basic() {
        ...
        let path1 = PathBuf::from("test1.d");
    ...
    fn test_dependency_tracking() {
        ...
        let path1 = PathBuf::from("main.d");
        let path2 = PathBuf::from("lib.d");
    ...
    fn test_cycle_detection() {
        ...
        let unit1 = CompilationUnit::new(PathBuf::from("a.d"), ContentHash::from_bytes(b"a"));
        let unit2 = CompilationUnit::new(PathBuf::from("b.d"), ContentHash::from_bytes(b"b"));
    ...
    fn test_invalidation() {
        ...
        let unit1 = CompilationUnit::new(PathBuf::from("a.d"), ContentHash::from_bytes(b"a"));
        let unit2 = CompilationUnit::new(PathBuf::from("b.d"), ContentHash::from_bytes(b"b"));
        let unit3 = CompilationUnit::new(PathBuf::from("c.d"), ContentHash::from_bytes(b"c"));
