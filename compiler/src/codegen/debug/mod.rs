    ...
    pub fn new(file: PathBuf, directory: PathBuf) -> Self {
        DebugInfoBuilder {
            compile_unit: CompileUnit {
                file,
                directory,
                producer: format!("Demetrios Compiler {}", env!("CARGO_PKG_VERSION")),
...
mod tests {
    ...
    fn test_debug_info_builder() {
        let mut builder =
            DebugInfoBuilder::new(PathBuf::from("test.d"), PathBuf::from("/home/user/project"));
        ...
        // Begin a function
        let _idx = builder.begin_subprogram("main", "_D4main", PathBuf::from("test.d"), 1, fn_type);
        ...
        // Add line entries
        builder.add_line_entry(0x1000, PathBuf::from("test.d"), 1, 1);
        builder.add_line_entry(0x1010, PathBuf::from("test.d"), 2, 5);
