...
pub struct SourceMap {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub x_demetrios: Option<DemetriosExtensions>,
}

/// D-specific source map extensions
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct DemetriosExtensions {
...
impl SourceMap {
    ...
    pub fn extensions(&self) -> Option<&DemetriosExtensions> {
        self.x_demetrios.as_ref()
    }
}
...
mod tests {
    ...
    fn test_source_map_builder() {
        ...
        let source = PathBuf::from("test.d");
        ...
        assert!(source_map.x_demetrios.is_some());
    }
