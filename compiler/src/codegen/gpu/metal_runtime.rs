...
//! Demetrios GPU kernels on Apple Silicon and Intel Macs.
//!
//! # Architecture
//!
//! ```text
//! Demetrios MSL → Metal Library → Pipeline State → Command Encoder → GPU
//! ```
//!
//! # Key Metal Concepts
//!
...
//!
//! ```ignore
//! use demetrios::codegen::gpu::metal_runtime::*;
//!
