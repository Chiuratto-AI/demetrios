//! Error Codes Registry for the Demetrios Compiler
//!
...
impl ErrorIndex {
    ...
    pub fn generate_docs(&self) -> String {
        ...
        doc.push_str("# Demetrios Compiler Error Index\n\n");
        doc.push_str("This document lists all error codes produced by the Demetrios compiler.\n\n");
    ...
    fn register_all(&mut self) {
        ...
        self.register(ErrorCode {
            ...
            explanation: "The source file contains a character that is not valid in Demetrios source code.",
