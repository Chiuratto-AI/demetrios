//! Diagnostic System for the Demetrios Compiler
//!
...
//!
//! ```rust,ignore
//! use demetrios::diagnostic::{Diagnostic, DiagnosticLevel, DiagnosticBuilder, Span};
//!
...
mod tests {
    ...
    fn test_source_file_line_col() {
        let source = "line one\nline two\nline three";
        let file = SourceFile::new(1, PathBuf::from("test.d"), source.to_string());
