        ...
        jobs.insert(
            ...
            Job {
                ...
                steps: vec![
                    ...
                    Step {
                        name: Some("Build".into()),
                        run: Some("dc build --target ${{ matrix.target }} --release".into()),
                        ..Default::default()
                    },
                    Step {
                        name: Some("Test".into()),
                        run: Some("dc test".into()),
                        ..Default::default()
                    },
                    Step {
            ...
            Job {
                ...
                steps: vec![
                    ...
                    Step {
                        ...
                        run: Some("dc test --all".into()),
                        ..Default::default()
                    },
                    Step {
                        name: Some("Run linter".into()),
                        run: Some("dc lint --deny warnings".into()),
                        ..Default::default()
                    },
                    Step {
                        name: Some("Check formatting".into()),
                        run: Some("dc fmt --check".into()),
                        ..Default::default()
                    },
                ],
                needs: None,
            ...
            Job {
                ...
                steps: vec![
                    ...
                    Step {
                        ...
                        run: Some("dc ci provenance --output provenance-${{ matrix.target }}.json".into()),
                        ..Default::default()
                    },
                    Step {
                        name: Some("Upload artifacts".into()),
