    ...
    pub fn generate(&self) -> Pipeline {
        ...
        jobs.insert(
            ...
            GitLabJob {
                ...
                script: vec!["dc build --target $TARGET --release".into()],
                before_script: Some(vec!["dc --version".into()]),
                after_script: None,
        ...
        jobs.insert(
            ...
            GitLabJob {
                stage: "test".into(),
                image: Some(self.image.clone()),
                script: vec!["dc fmt --check".into(), "dc lint".into()],
                before_script: None,
                after_script: None,
                variables: HashMap::new(),
                artifacts: Some(Artifacts {
