...
//!
//! This is the foundational type that makes Demetrios unique:
//! Every value knows where it came from, how certain it is,
//! what domain validates it, and how it was transformed.
//!
//! # Core Innovation
//!
//! Type checking in Demetrios IS ontological reasoning:
...
///
/// Demetrios uses a 4-layer ontology architecture:
