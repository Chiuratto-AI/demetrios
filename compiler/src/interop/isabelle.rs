//! Isabelle/HOL Interoperability for Demetrios
//!
//! Native integration with Isabelle/HOL proof assistant enabling:
//! - Export Demetrios refinements/geometry to Isabelle theories
...
impl IsabelleServer {
    ...
    pub fn run_theory(&self, theory_code: &str) -> Result<IsabelleOutput, IsabelleExecutionError> {
        ...
        let temp_dir = std::env::temp_dir().join("demetrios_isabelle");
...
impl IsabelleInterop {
    ...
    /// Export a Demetrios refinement constraint to Isabelle theory
