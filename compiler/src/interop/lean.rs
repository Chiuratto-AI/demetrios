//! Lean 4 Interoperability for Demetrios
//!
//! Native integration with Lean 4 proof assistant enabling:
//! - Export Demetrios refinements/geometry to Lean theorems
...
impl LeanServer {
    ...
    pub fn run_code(&self, code: &str) -> Result<LeanOutput, LeanExecutionError> {
        ...
        let temp_file = temp_dir.join("demetrios_lean_proof.lean");
...
impl LeanInterop {
    ...
    pub fn export_geometry_predicate(&self, predicate: &GeometryPredicate) -> String {
        ...
        code.push_str("-- Auto-generated from Demetrios geometry\n");
        ...
        code.push_str("namespace Demetrios.Geometry\n\n");
    ...
    pub fn export_causal_constraint(&self, constraint: &CausalConstraint) -> String {
        ...
        code.push_str("-- Auto-generated from Demetrios causal model\n");
    ...
    fn translate_predicate_to_lean(&self, pred: &str) -> String {
        // Basic translation of Demetrios predicates to Lean
        pred.replace("&&", "\u{2227}")
            .replace("||", "\u{2228}")
            .replace("!", "\u{00ac}")
            .replace(">=", "\u{2265}")
...
/// A refinement constraint from Demetrios
#[derive(Debug, Clone)]
