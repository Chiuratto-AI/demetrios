...
//! proof assistants, enabling Demetrios to leverage powerful proof
...
//!
//! 1. **Export**: Translate Demetrios refinements/geometry/causal to prover syntax
...
//! - Integration with Demetrios epistemic propagation for approximate numerics
...
/// providing a common interface for Demetrios to interact with them.
