//! Linearity Kinds for the Demetrios Type System
//!
//! Day 44 of the Demetrios compiler implements linearity as a kind system,
...
//!
//! Every type in Demetrios carries a linearity annotation:
//!
//! ```text
