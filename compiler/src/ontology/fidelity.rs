//! World Fidelity Verification for Demetrios
//!
...
//!
//! ```rust,ignore
//! use demetrios::ontology::fidelity::{WorldFidelityChecker, FidelityResult};
//!
...
///
/// This is the core system that ensures Demetrios programs maintain epistemic
