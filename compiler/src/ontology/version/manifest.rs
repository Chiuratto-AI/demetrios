...
//! # Generated by Demetrios compiler
//!
//! [metadata]
...
pub struct ManifestMetadata {
    ...
    /// Demetrios compiler version
    pub demetrios_version: String,
...
impl Default for ManifestMetadata {
    fn default() -> Self {
        Self {
            ...
            demetrios_version: env!("CARGO_PKG_VERSION").to_string(),
...
impl Manifest {
    ...
    fn parse_metadata_field(
        ...
        match key {
            ...
            "demetrios_version" => self.metadata.demetrios_version = value.to_string(),
            "schema_version" => {
    ...
    pub fn to_toml(&self) -> String {
        ...
        output.push_str("# Generated by Demetrios compiler\n\n");
        ...
        output.push_str(&format!(
            "demetrios_version = \"{}\"\n",
            self.metadata.demetrios_version
        ));
        output.push_str(&format!(
            "schema_version = {}\n",
