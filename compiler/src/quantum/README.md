...
```rust
use demetrios::quantum::EpistemicAmplitude;
...
```rust
use demetrios::quantum::MolecularHamiltonian;
...
```rust
use demetrios::quantum::{MolecularHamiltonian, MolecularVQEResult, EpistemicAmplitude};
...
| Traditional (Qiskit, Cirq, etc.) | Epistemic Demetrios |
|-----------------------------------|---------------------|
...
Part of the Demetrios compiler project. See main LICENSE file.
...
```
@software{demetrios_epistemic_quantum,
  title = {Epistemic Quantum Computing in Demetrios},
  author = {Demetrios Development Team},
  year = {2024},
