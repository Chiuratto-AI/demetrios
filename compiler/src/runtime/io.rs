//! I/O Runtime Support for Demetrios
//!
//! This module provides C-compatible runtime functions for file I/O operations
//! that are called from compiled Demetrios programs. These functions match the
...
//! responsible for calling `__demetrios_free_string` to deallocate.
...
/// - 4 for other errors
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_read_file(
    path: *const u8,
    path_len: i64,
    out_ptr: *mut *mut u8,
    out_len: *mut i64,
...
/// - 4 for other errors
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_write_file(
    path: *const u8,
    path_len: i64,
    content: *const u8,
    content_len: i64,
...
/// - 4 for other errors
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_append_file(
    path: *const u8,
    path_len: i64,
    content: *const u8,
    content_len: i64,
...
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_file_exists(path: *const u8, path_len: i64) -> i32 {
    if path.is_null() {
        return -1;
    }
...
/// - 4 for other errors
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_remove_file(path: *const u8, path_len: i64) -> i32 {
    if path.is_null() {
        return 3;
    }
...
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_exit(code: i32) -> ! {
...
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_get_argc() -> i32 {
    init_args();
...
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_get_argv(
    index: i32,
    out_ptr: *mut *mut u8,
    out_len: *mut i64,
) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_get_env(
    name: *const u8,
    name_len: i64,
    out_ptr: *mut *mut u8,
    out_len: *mut i64,
...
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_set_env(
    name: *const u8,
    name_len: i64,
    value: *const u8,
    value_len: i64,
...
/// - 4 on error
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_current_dir(out_ptr: *mut *mut u8, out_len: *mut i64) -> i32 {
    if out_ptr.is_null() || out_len.is_null() {
        return 3;
    }
...
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_print(s: *const u8, len: i64) {
    if s.is_null() {
        return;
    }
...
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_eprint(s: *const u8, len: i64) {
    if s.is_null() {
        return;
    }
...
/// - 4 on error
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_read_line(out_ptr: *mut *mut u8, out_len: *mut i64) -> i32 {
    if out_ptr.is_null() || out_len.is_null() {
        return 3;
    }
...
#[unsafe(no_mangle)]
pub extern "C" fn __demetrios_free_string(ptr: *mut u8, len: i64) {
...
mod tests {
    ...
    fn test_file_exists() {
        ...
        let path = ".";
        let result = __demetrios_file_exists(path.as_ptr(), path.len() as i64);
    ...
    fn test_read_write_file() {
        ...
        // Write file
        let write_result = __demetrios_write_file(
            test_path.as_ptr(),
        ...
        let read_result = __demetrios_read_file(
            test_path.as_ptr(),
            test_path.len() as i64,
            &mut out_ptr,
            &mut out_len,
        ...
        // Free the string
        __demetrios_free_string(out_ptr, out_len);

        // Clean up
        let _ = __demetrios_remove_file(test_path.as_ptr(), test_path.len() as i64);
    }
    ...
    fn test_get_env() {
        ...
        let result =
            __demetrios_get_env(name.as_ptr(), name.len() as i64, &mut out_ptr, &mut out_len);
        assert_eq!(result, 0);
    ...
    fn test_current_dir() {
        ...
        let result = __demetrios_current_dir(&mut out_ptr, &mut out_len);
        assert_eq!(result, 0);
        assert!(!out_ptr.is_null());
        assert!(out_len > 0);
    ...
    fn test_argc_argv() {
        ...
        let argc = __demetrios_get_argc();
        assert!(argc > 0); // At least the program name

        // Get first argument (program name)
        let mut out_ptr: *mut u8 = ptr::null_mut();
        let mut out_len: i64 = 0;
        let result = __demetrios_get_argv(0, &mut out_ptr, &mut out_len);
        assert_eq!(result, 0);

        __demetrios_free_string(out_ptr, out_len);

        // Out of bounds should return 1
        let result = __demetrios_get_argv(9999, &mut out_ptr, &mut out_len);
        assert_eq!(result, 1);
    }
}
