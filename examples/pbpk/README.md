# Darwin PBPK in Demetrios

Comprehensive PBPK (Physiologically-Based Pharmacokinetic) modeling in Demetrios.

## Overview

This directory contains the Darwin PBPK platform ported to Demetrios, showcasing:
...
## Key Demetrios Features for PBPK
