...
//! capabilities in the Demetrios language, including:
...
fn main() with IO, Alloc, Prob {
    println!("🧬 Demetrios Scientific Computing Demo");
    println!("=====================================");
    ...
    println!("\n✅ Scientific computing demonstration completed!");
}
...
fn demonstrate_pk_modeling() with IO, Alloc {
    ...
    println!("AUC(0-48h): {:.1} mg·h/L", pk_result.auc[pk_result.auc.len()-1]);
...
fn demonstrate_nca() with IO {
    ...
    println!("AUC(0-last): {:.1} mg·h/L", nca_result.auc_last);
    println!("AUC(0-∞): {:.1} mg·h/L", nca_result.auc_inf);
    ...
    println!("R²: {:.3}", nca_result.r_squared);
}
