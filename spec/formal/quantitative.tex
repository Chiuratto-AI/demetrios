% Quantitative Type Theory for Demetrios
...
\title{Quantitative Type Theory for Demetrios\\
\large Formal Specification v0.51}
\author{Demetrios Language Team}
...
\begin{abstract}
This specification defines the formal foundations for Demetrios' type system
...
Demetrios integrates 15M+ ontological types (from SNOMED-CT, ICD-10, etc.)
...
This specification establishes the formal foundations for Demetrios' L0
